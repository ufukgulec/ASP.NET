<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="girisYap.aspx.cs" Inherits="ASP.NET_Login.girisYap" %>
...
<body>
  ...
  <div class="form-group form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">Beni Hatırla</label>
            ...
            <asp:Button type="submit" class="btn btn-primary" ID="giris" runat="server" Text="Giriş Yap" OnClick="giris_Click" />
        </div>
    </form>
</body>
</html>
